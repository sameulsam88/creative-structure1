  ...
  >
    <div className="mx-auto flex h-[70px] max-w-7xl items-center justify-between px-5 sm:px-8">
      ...
      {/* 
        ...
        FIXED LOGO SECTION
        ========================================
        1. Moved inside the flex container so it aligns left.
        2. Wrapped in an <a> tag (best practice for logos).
        3. Replaced non-standard heights with standard Tailwind (h-12, h-14, h-16).
        4. Changed object-cover to object-contain so it doesn't crop.
      */}
      <a 
        href="/" 
        aria-label="Home"
      ...
      <div className="flex items-center gap-3">
        ...
        <a href="#contact" className="btn btn-red group hidden sm:inline-flex">
          Request a Quote
